...
public class Security {
    ...
    * get back the purchase state and send a confirmation message back to Android Market. If we are killed and lose this
    * list of nonces, it is not fatal. Android Market will send us a new "notify" message and we will re-generate a new
...
//      }
      ...
      if (!TextUtils.isEmpty(signature)) {
          ...
          * 
          * Instead of just storing the entire literal string here embedded in the program, construct the key at runtime
          * from pieces or use bit manipulation (for example, XOR with some other string) to hide the actual key. The
          * key itself is not secret information, but we don't want to make it easy for an adversary to replace the
          ...
          */
         String base64EncodedPublicKey = "";
