 ...
 */
public class GoodNameAdapter extends ArrayAdapter<String> {
    ...
    public GoodNameAdapter(Activity activity, int textViewResourceId, List<String> objects) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.good_name_item, null);
